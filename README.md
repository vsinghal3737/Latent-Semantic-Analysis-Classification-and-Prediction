...
3.	To download Postman: [click here](https://www.postman.com/)<br>
	[what is postman?](https://www.geeksforgeeks.org/introduction-postman-api-development/)

4.	To install Libraries that used in the project<br>
	Type in the command prompt: `pip install -r requirements.txt` in root dir of the project

5.	To check if everything installed properly<br>
	In command prompt: `python`<br>
	In Python console: `import flask, numpy, pandas, json, sklearn`<br>
	**If you get no error, Project Setup is Done**

6.	To run the project:<br>
	Extract shuffled-full-set-hashed.csv file in `Problem` folder in the same dir.<br>
	Open Command Prompt and navigate to `Solution/Final` where app.py file is located and type: `python app.py`<br>
